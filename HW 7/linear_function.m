...
%    normsq(lf)
%    --> norm-squared of a linear function represented as a
%        quadratic function
%    disp(lf)
...
classdef linear_function
    ...
    methods
        ...
        % norm-squared of a linear function
        function qf = normsq(lf)
            qf = norm_squared_linear(lf);
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function qf = norm_squared_linear(lf)
    A = lf.A;
    b = lf.b;
    
    qf = 2*quadratic_function(A'*A,A'*b,b'*b);
end
